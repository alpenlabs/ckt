//! Aarch64-specific execution instance implementation.
...
/// Aarch64-specific execution instance implementation.
#[derive(Debug)]
pub struct Aarch64ExecutionInstance {
    working_space: BitVec,
}

impl Aarch64ExecutionInstance {
...
impl ExecutionInstance for Aarch64ExecutionInstance {
